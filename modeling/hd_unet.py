...
class HDUNet(nn.Module):
    def __init__(self, in_ch=9, growth_rate=16, upsample_chan=64):
...
if __name__ == "__main__":
    ...
    x = torch.rand(1, 9, 128, 128, 128)  # Example input tensor with shape (batch_size, channels, depth, height, width)
    model = HDUNet()    
